...
-- ==========================================
-- THE AUDIO BRAINROT LOOP
-- ==========================================
local function audioLoop()
    if #speakers == 0 then
        -- If this dumbass forgot speakers, just sleep so it doesn't break
        while true do os.sleep(1) end
    end
    
    local instruments = {"cow_bell", "bit", "banjo", "didgeridoo", "pling"}
    
    while true do
        for _, s in pairs(speakers) do
            -- Spams random obnoxious pitches on annoying instruments
            s.playNote(instruments[math.random(1, #instruments)], 3, math.random(0, 24))
        end
        -- 0.08 seconds is peak TikTok ADHD brainrot speed
        os.sleep(0.08) 
    end
end

-- ==========================================
-- THE VISUAL SHITPOST LOOP
-- ==========================================
local function visualLoop()
    while true do
        ...
        -- SCENE 7: Enchanting Table Trash 
        ...
        -- SCENE 15: The Unhinged Bouncing Freakout 
        ...
        -- SCENE 22: ASCII Art 1 - The Trash Can 
        blast(colors.black, colors.lightGray)
        ...
        -- SCENE 24: Defragmenting Remaining Brain Cells 
        blast(colors.black, colors.lime)
